import pytest
import requests
from constants import AUTH_BASE_URL, HEADERS, REGISTER_ENDPOINT, LOGIN_ENDPOINT
...
class TestPositiveAuthApi:
    ...
    def test_auth_user(self, test_user):
        ...
        assert login_response.status_code in [200, 201], f'Ошибка авторизации пользователя'
